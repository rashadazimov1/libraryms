...
public class AuthorMapperImpl implements AuthorMapper {
    ...
    public List<AuthorDto> toDtoList(List<Author> authors) {
        ...
        for ( Author author : authors ) {
            list.add( authorEntityToDto( author ) );
        }
    ...
    protected Set<AuthorDto> authorSetToAuthorDtoSet(Set<Author> set) {
        ...
        for ( Author author : set ) {
            set1.add( authorEntityToDto( author ) );
        }
    ...
    protected CategoryDto categoryToCategoryDto(Category category) {
        ...
        categoryDto.setBook( bookToBookDto( category.getBook() ) );
    ...
    protected Set<Author> authorDtoSetToAuthorSet(Set<AuthorDto> set) {
        ...
        for ( AuthorDto authorDto : set ) {
            set1.add( authorDtoToEntity( authorDto ) );
        }
    ...
    protected Category categoryDtoToCategory(CategoryDto categoryDto) {
        ...
        category.setBook( bookDtoToBook( categoryDto.getBook() ) );
